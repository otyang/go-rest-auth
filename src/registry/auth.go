...
func (r *registry) NewAuthController() interfaceController.AuthController {
	return interfaceController.NewAuthController(r.NewAuthInteractor(), r.jwtConf)
}

func (r *registry) NewAuthInteractor() usecaseInteractor.AuthInteractor {
	return usecaseInteractor.NewAuthInteractor(r.NewAuthRepository(), r.NewAuthPresenter())
}
